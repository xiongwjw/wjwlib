...
namespace wjw.helper.Extensions
{
    ...
    public static class BitmapExtensions
    {
        ...
        #region ScaleProportional(按指定比例缩放位图)
        /// <summary>
        /// 按指定比例缩放位图
        /// </summary>
        /// <param name="bitmap">位图</param>
        ...
        #region ScaleToSizeProportional(按指定的大小比例缩放位图)
        /// <summary>
