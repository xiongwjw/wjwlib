...
namespace wjw.helper.Extensions
{
    ...
    /// 系统扩展 - 公共扩展
    /// </summary>
    public static partial class wjwHelperExtensions
    {
        ...
        //public static int Value(this System.Enum instance) => wjw.helper.Helpers.Enum.GetValue(instance.GetType(), instance);
        ...
        /// <param name="instance">枚举实例</param>
        //public static TResult Value<TResult>(this System.Enum instance) => wjw.helper.Helpers.Conv.To<TResult>(Value(instance));
        ...
        /// </summary>
        /// <param name="instance">枚举实例</param>
        public static string Description(this System.Enum instance) => wjw.helper.Enums.GetDescription(instance.GetType(), instance);
        ...
        public static string Join<T>(this IEnumerable<T> list, string quotes = "", string separator = ",") => wjw.helper.Text.CStr.Join(list, quotes, separator);
