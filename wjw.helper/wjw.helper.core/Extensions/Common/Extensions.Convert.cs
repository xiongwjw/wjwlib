...
namespace wjw.helper.Extensions
{
    ...
    public static partial class wjwHelperExtensions
    {
        ...
        public static string ToSnakeCase(this string str) => wjw.helper.Text.CStr.ToSnakeCase(str);
        ...
        /// </summary>
        /// <param name="str">字符串</param>
        public static string ToCamelCase(this string str) => wjw.helper.Text.CStr.ToCamelCase(str);
