...
namespace wjw.helper
{
    ...
    public static partial class Check
    {
        ...
        public static void NotNullOrEmpty(string value, string paramName)
        {
            ...
            Require<ArgumentException>(!string.IsNullOrEmpty(value), paramName);
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public static void NotEmpty(Guid value, string paramName) => Require<ArgumentException>(value != Guid.Empty, paramName);
        ...
        public static void NotNullOrEmpty<T>(IEnumerable<T> collection, string paramName)
        {
            ...
            Require<ArgumentException>(collection.Any(), paramName);
        }
        ...
        public static void NotNullOrEmpty<T>(IDictionary<string, T> dictionary, string paramName)
        {
            ...
            Require<ArgumentException>(dictionary.Any(), paramName);
        }
            ...
            where T : IComparable<T>
        {
            ...
            Require<ArgumentOutOfRangeException>(flag, paramName);
        }
            ...
            bool endEqual = false) where T : IComparable<T>
        {
            ...
            Require<ArgumentOutOfRangeException>(flag, string.Empty);
        }
        ...
        public static void DirectoryExists(string directory, string paramName = null)
        {
            ...
            Require<DirectoryNotFoundException>(Directory.Exists(directory), paramName);
        }
        ...
        public static void FileExists(string fileName, string paramName = null)
        {
            ...
            Require<FileNotFoundException>(File.Exists(fileName), fileName);
        }
